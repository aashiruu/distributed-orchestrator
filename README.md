...
## 🏗️ Architecture Design & Topology
...
2. Launch the Orchestrator Service (Port 8080)
Bash
go run cmd/orchestrator/main.go
3. Launch the Worker Node Pool (Port 8081 Scraper)
Bash
go run cmd/worker/main.go
4. Inject Automated Chaos and Load Tests
Bash
